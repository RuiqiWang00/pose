...
_C.MODEL = CN()
_C.MODEL.NAME = 'CID'
_C.MODEL.KERNEL_DIM= 64
_C.MODEL.NUM_PERSONS= 100
...
_C.MODEL.IIA.DIM= 128
_C.MODEL.IIA.NUM_CONVS= 3
_C.MODEL.IIA.NUM_GROUPS= 4
_C.MODEL.GFD = CN()
_C.MODEL.GFD.IN_CHANNELS = 480
_C.MODEL.GFD.CHANNELS = 32
_C.MODEL.GFD.OUT_CHANNELS = 17
_C.MODEL.GFD.NUM_CONVS=4
_C.MODEL.GFD.DIM=256

_C.LOSS = CN()
_C.LOSS.SCORE_LOSS_WEIGHT = 1.0
_C.LOSS.SINGLE_HEATMAP_LOSS_WEIGHT = 1.0
_C.LOSS.SINGLE_HEATMAP_COST_WEIGHT = 1.0
_C.LOSS.OFFSET_WEIGHT = 1.0
_C.LOSS.OFFSET_COST_WEIGHT = 1.0

# DATASET related params
_C.DATASET = CN()
_C.DATASET.ROOT = 'data'
_C.DATASET.DATASET = 'ochuman'
_C.DATASET.FILE_NAME='person_keypoints'
...
_C.TEST.THRESHOLD = 0.01
_C.TEST.KERNEL_SIZE = 3
